...
func GetDefaultTemplates() map[string]*NotificationTemplate {
	return map[string]*NotificationTemplate{
		...
		"test": {
			...
			Body:           "This is a test notification from {server} to verify your notification configuration is working correctly.\n\nSent at: {timestamp}",
			DefaultSubject: "Radarr Test Notification",
			DefaultBody:    "This is a test notification from {server} to verify your notification configuration is working correctly.\n\nSent at: {timestamp}",
		},
	}
}
