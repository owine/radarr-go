...
func TestParseService(t *testing.T) {
	...
	t.Run("ParseReleaseTitle", func(t *testing.T) {
		testParseReleaseTitle(t, service)
	})

	t.Run("ParseMultipleTitles", func(t *testing.T) {
		testParseMultipleTitles(t, service)
	})

	t.Run("CacheResults", func(t *testing.T) {
		testCacheResults(t, service)
	})

	t.Run("ClearCache", func(t *testing.T) {
		testClearCache(t, service)
	})

	t.Run("QualityExtraction", func(t *testing.T) {
		testQualityExtraction(t, service)
	})
}

// testParseReleaseTitle tests parsing single release titles
func testParseReleaseTitle(t *testing.T, service *ParseService) {
...
// testParseMultipleTitles tests parsing multiple titles at once
func testParseMultipleTitles(t *testing.T, service *ParseService) {
	ctx := context.Background()
	titles := []string{
...
// testCacheResults tests that parsing results are cached
func testCacheResults(t *testing.T, service *ParseService) {
	ctx := context.Background()
...
func testClearCache(t *testing.T, service *ParseService) {
	ctx := context.Background()
...
// testQualityExtraction tests extraction of quality information
func testQualityExtraction(t *testing.T, service *ParseService) {
	ctx := context.Background()
	testCases := []struct {
		title           string
		expectedQuality string
